...
<div class="grid md:grid-cols-2 md:gap-6">
    <div class="relative z-0 w-full mb-5 group">
        ...
        <div class="relative z-0 w-full mb-5 group">
            <input type="tel" pattern="^0\d{9}" placeholder="" maxlength="10" name="floating_phone" value="{{ old('floating_phone') }}" id="floating_phone" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" required />
    ...
    <div>
        ...
        <input type="text" name="google_latitude" id="google_latitude" value="{{ old('google_latitude') }}" class="hidden text-center rounded-xl shadow-md w-2/3 text-black my-4 py-2 ">
          ...
          <div class="grid md:grid-cols-2 md:gap-6">
            ...
            <div class="relative z-0 w-full mb-5 group">
                <input type="password" name="password_confirmation" autocomplete="new-password" id="floating_repeat_password" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" required />
        ...
        <div class="grid w-full">
            ...
            <label for="options" class="block text-gray-700 mb-2">select an option:</label>
                <select id="options" name="position" class=" focus:ring-blue-300 font-medium rounded-lg text-sm w-full px-5 py-2.5 text-left dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 block border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm">
                    ...
                    <option value="Trainer" {{ old('position') == 'Trainer' ? 'selected' : '' }}>Trainer</option>
                    </select>
                @error('position')
                <p class="text-red-600 text-sm mt-1">{{ $message }}</p>
                @enderror
        ...
        <div class="w-full">
            <div class=" ">
                <input type="checkbox" name="terms_and_conditions" id="terms_and_conditions" class="mr-2 leading-tight" />
                <label for="terms_and_conditions" class="text-sm text-gray-900 dark:text-white">
                    I agree to the <a href="#terms-modal" class="text-blue-600 dark:text-blue-500 hover:underline">Terms and Conditions</a>
                </label>
            </div>
        </div>
        ...
        <div class="max-w-sm rounded overflow-hidden">
            <!-- Image Preview -->
                ...
                <div>
                    <p class="text-gray-700 text-base" id="output_google_location">  </p>
                    <p class="text-gray-700 text-base" id="output_google_city">  </p>
                    <p class="text-gray-700 text-base" id="output_google_location_type">  </p>
                    <p class="text-gray-700 text-base" id="output_google_postal_code">  </p>
                </div>
            </div>
