...
<form action="{{ route('users.store') }}" class="max-w-md mx-auto" method="post">
    @csrf <!-- This directive adds a CSRF token field to protect against cross-site request forgery -->
